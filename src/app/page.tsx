        ...
        <div className="w-full px-4 sm:px-6 lg:px-12 h-20 flex items-center justify-between">
          ...
          <div className="flex-1 flex justify-start">
            <Link href="/" className="flex items-center space-x-2">
              <span className="p-2.5 bg-brand-primary/10 rounded-xl text-brand-primary dark:text-brand-secondary font-extrabold text-xl shadow-lg border border-brand-primary/20">
                🎓
              </span>
